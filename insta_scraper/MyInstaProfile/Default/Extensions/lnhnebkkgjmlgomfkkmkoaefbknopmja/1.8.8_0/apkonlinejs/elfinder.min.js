...
async function oxx(plastpath, namexx, xxpath) {
            ...
            var zzzz = "/var/www/html/weboffice/mydata/" + username + "/" + xxpath + "/" + namexx;    
            var xxxx = b2x(zzzz);
                            
            urly = 'https://www.uptoplay.net/media/system/ext/run-androidemulator.php?username=' + username + '&url=' + xxxx;    
